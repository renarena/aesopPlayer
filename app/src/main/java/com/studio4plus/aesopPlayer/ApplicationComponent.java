...
import com.studio4plus.aesopPlayer.content.ConfigurationContentProvider;
import com.studio4plus.aesopPlayer.model.AudioBookManager;
import com.studio4plus.aesopPlayer.model.DemoSamplesInstaller;
import com.studio4plus.aesopPlayer.player.Player;
import com.studio4plus.aesopPlayer.service.AudioBookPlayerModule;
import com.studio4plus.aesopPlayer.service.DemoSamplesInstallerService;
import com.studio4plus.aesopPlayer.service.DeviceMotionDetector;
import com.studio4plus.aesopPlayer.service.PlaybackService;
import com.studio4plus.aesopPlayer.ui.provisioning.CandidateFragment;
import com.studio4plus.aesopPlayer.ui.provisioning.InventoryItemFragment;
import com.studio4plus.aesopPlayer.ui.classic.ClassicPlaybackUi;
import com.studio4plus.aesopPlayer.ui.classic.FragmentBookItem;
import com.studio4plus.aesopPlayer.ui.classic.ClassicBookList;
import com.studio4plus.aesopPlayer.ui.classic.ClassicNoBooksUi;
import com.studio4plus.aesopPlayer.ui.classic.ClassicInitUi;
import com.studio4plus.aesopPlayer.ui.provisioning.Provisioning;
import com.studio4plus.aesopPlayer.ui.provisioning.ProvisioningActivity;
import com.studio4plus.aesopPlayer.ui.settings.KioskSelectionPreference;
import com.studio4plus.aesopPlayer.ui.settings.KioskSettingsFragment;
import com.studio4plus.aesopPlayer.ui.settings.MainSettingsFragment;
import com.studio4plus.aesopPlayer.ui.settings.PlaybackSettingsFragment;
import com.studio4plus.aesopPlayer.ui.classic.FragmentPlayback;
